...
import { useLanguage } from "@/components/LanguageProvider"; // Import your language hook
import { Download, FileText, ExternalLink } from "lucide-react";

/* -------------------------------------------------------------------------- */
/* CONFIGURATION */
/* -------------------------------------------------------------------------- */
const PDF_URL = "https://res.cloudinary.com/drnascc38/image/upload/v1767088868/Profile_and_Catalogue_1_1_aassgi.pdf";
    ...
    <section className="py-24 bg-slate-50" id="catalog">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
          <div className="max-w-2xl space-y-4">
            ...
            <h2 className="text-4xl font-serif font-bold text-slate-900">
              {t.header.titlePart1} <span className="text-amber-700">{t.header.titlePart2}</span>
            </h2>
          ...
          <a href={PDF_URL} download target="_blank" rel="noopener noreferrer">
             <Button size="lg" className="bg-slate-900 hover:bg-slate-800 text-white shadow-lg h-12 px-8">
        ...
        <p className="text-center text-sm text-slate-400 mt-6 md:hidden">
           ...
           <a href={PDF_URL} target="_blank" className="underline text-amber-700 font-medium ml-1 inline-flex items-center">
